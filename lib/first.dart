...
,child:Column(
          ...
          focusedBorder:OutlineInputBorder(
            ...
            borderRadius: BorderRadius.circular(25.0),
                 ...
                 border: OutlineInputBorder(borderSide: const BorderSide(color: Colors.pink, width: 2.0),
            borderRadius: BorderRadius.circular(25.0), ),
                  labelText: 'User Name',
...
@override
  ...
  Future register(String name,String pass,String email,String place,String phone1) async{
 ...
 Container(
      ...
      fillColor: Colors.grey[500]!.withOpacity(0.4),
          focusedBorder:OutlineInputBorder(
            ...
            textInputAction: TextInputAction.next,
                              controller: passwordController2,obscureText: true,
enableSuggestions: false,
autocorrect: false,
              decoration: InputDecoration(
             filled: true,
   ...
   // Text Color (Foreground color)
                  ...
                  onPressed: () {
                   ...
                   emailController2.text!=''&&
                    ...
                    register(nameController2.text,passwordController2.text,emailController2.text,placeController2.text,phoneController2.text);
                  else 
                  {
                    AlertDialog alert = AlertDialog(  
